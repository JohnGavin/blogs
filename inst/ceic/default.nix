...
# with following call:
# >rix::rix(r_ver = "7872526e9c5332274ea5932a0c3270d6e4724f3b",
#  > r_pkgs = c(pkgs_dev,
...
let
 ...
 rpkgs = builtins.attrValues {
  inherit (pkgs.rPackages) arrow Cairo DBI devtools dplyr duckdb fs ggplot2 glue goodpractice here httpgd lmtest lubridate pacman patchwork purrr quarto readr reticulate rmarkdown roll rvest sandwich stringr tarchetypes targets tibbletime tidyfit tidyr visNetwork;
};
...
(pkgs.rPackages.buildRPackage {
  ...
  inherit (pkgs) R glibcLocales nix cairo clang libffi nano oh-my-zsh openssl quarto radianWrapper readline;
};
  in
  pkgs.mkShell {
